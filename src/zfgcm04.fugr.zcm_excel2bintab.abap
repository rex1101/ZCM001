...
*"     REFERENCE(I_FILENA) TYPE  BDS_FILENA
...
*  FREE MEMORY ID 'Z_TMP_ZDOI_EXCEL_DOWNLOAD'.
  ...
  PERFORM FRM_SAVE_COPY2INTABLE USING GR_PROXY CHANGING GT_SOLIX.

  ET_SOLIX[] = GT_SOLIX[].

  CALL METHOD GR_PROXY->CLOSE_DOCUMENT .
  CALL METHOD GR_CONTROL->DESTROY_CONTROL.
*  CALL METHOD GR_CONTROL->RELEASE_DOCUMENT.
