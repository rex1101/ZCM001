*&---------------------------------------------------------------------*
* Program Name     : YDEMO_OOFSALV
* Program Purpose  : Call Method Split OO ALV Function Demo
* Author           : SUN HUIMING
* Date Written     : 2014/12/04
* Note             : N/A
*&---------------------------------------------------------------------*
REPORT  YDEMO_OOFSALV.
...
DATA: GT_OUT2 TYPE TABLE OF SCARR.
...
DATA: GO_OOALV1 TYPE REF TO ZCL_CM_OO_ALV.
DATA: GO_OOALV2 TYPE REF TO ZCL_CM_OO_ALV.
DATA: GO_OOALV3 TYPE REF TO ZCL_CM_OO_ALV.
DATA: GO_OOALV4 TYPE REF TO ZCL_CM_OO_ALV.
...
FORM FRM_SHOW_ALV .
  ...
  DATA: LT_CONTAINER TYPE ZCM_OOALV_SPLIT_LIST_TY,
      LS_CONTAINER TYPE ZCM_OOALV_SPLIT_LIST.
...
MODULE USER_COMMAND_9000 INPUT.
  CASE G_OKCD.
    WHEN 'EXIT' OR 'BACK'.
      CALL METHOD GO_OOALV1->FREE.
      CALL METHOD GO_OOALV2->FREE.
      LEAVE TO SCREEN 0.
    WHEN  'CANC'.
      LEAVE PROGRAM.
    WHEN OTHERS.
